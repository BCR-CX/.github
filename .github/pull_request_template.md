# [Título do PR]
<!-- 
PR em português, commits em inglês, caso necessário, pode fazer as referências e documentações em inglês.
De preferência, commits organizados, pois os mesmos vão para a descrição do commit final.
-->

## Prefácio
<!-- Pequeno resumo e o motivo pelo qual o PR está sendo solicitado. -->

# CHANGELOG
<!-- Histórico de mudanças referentes ao PR em tópicos (pode referenciar o SHA1 do commit) e marcar como quote se necessário. -->
<!-- 
Exemplo:
- [SHA1 do Commit]: [Título da mudança]
> [Descrição da mudança (caso necessário)]
-->

# BACKLOG
<!-- 
Tópico opcional para caso algo deste PR seja usado como requisito para outra feature (ou qualquer outra coisa).
Marque o ISSUE
-->

# ISSUES
<!-- Issues referentes ao PR solicitado (use para fechar os issues também). -->
<!-- 
Exemplo:
resolves #000
-->
